...
/**
 * Generator of {@code Duration} values.
 * 
...
extends AbstractTypedGenerator<Duration> {
     ...
     */
    @Override
    public @NotNull Duration defaultValue() {
     ...
     */
    @Override
    public @NotNull Duration randomValue() {
        ChronoUnit unit = Generators.randomValue(ChronoUnit.class);
