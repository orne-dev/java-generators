...
extends AbstractTypedGenerator<Path> {
     ...
     */
    @Override
    public @NotNull Path defaultValue() {
        return workingDir();
    }
     ...
     */
    @Override
    public @NotNull Path randomValue() {
        return Paths.get(randomPath());
    }
     ...
     */
    public static @NotNull Path workingDir() {
     ...
     */
    public static @NotNull Path userDir() {
     ...
     */
    public static @NotNull Path tmpDir() {
    ...
    protected static @NotNull String removeLastSeparator(
        ...
        if (path.endsWith(SEPARATOR)) {
            result = path.substring(0, path.length() - SEPARATOR.length());
        } else {
            result = path;
        }
        return result;
